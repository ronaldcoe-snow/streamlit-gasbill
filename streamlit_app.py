...
streamlit.slider("Select a year", min = (int(df_sl_years['TRANSACTIONYEAR'].min()), max = int(df_sl_years['TRANSACTIONYEAR'].max()), value = max = int(df_sl_years['TRANSACTIONYEAR'].min())))
# df_sl_years
